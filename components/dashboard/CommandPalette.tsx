...
export default function CommandPalette() {
  ...
  const commands: Cmd[] = useMemo(() => {
    const cmds: Cmd[] = [
      ...
      { id: 'support', label: 'Email support', hint: '?', group: 'Help', icon: <><path d="M4 4h16v12H5.17L4 17.17V4z" /></>, action: () => { window.location.href = 'mailto:support@bankxl.in'; setOpen(false) } },
    ]
