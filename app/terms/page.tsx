...
export default function Terms() {
  return (
    <LegalPage title="Terms of Service" updated="May 2026">
      ...
      <h2>2. Account</h2>
      <p>You are responsible for keeping your login credentials secure. Notify us immediately at <a href="mailto:support@bankxl.in">support@bankxl.in</a> if you suspect unauthorized access.</p>
      ...
      <h2>13. Contact</h2>
      <p>Questions? <a href="mailto:support@bankxl.in">support@bankxl.in</a></p>
    </LegalPage>
  )
}
