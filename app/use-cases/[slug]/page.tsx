...
import { USE_CASE_PAGES, ALL_USE_CASE_SLUGS } from './data'
...
export function generateMetadata({ params }: Props): Metadata {
  ...
  const ogTitle = encodeURIComponent(`BankXL for ${data.useCase}`)
...
export default function UseCasePage({ params }: Props) {
  ...
  const breadcrumbLD = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Use Cases', item: `${APP_URL}/use-cases/${data.slug}` },
      { '@type': 'ListItem', position: 3, name: data.useCase, item: `${APP_URL}/use-cases/${data.slug}` },
    ],
  }
    ...
    <div className="grid-bg" style={{ minHeight: '100vh', background: 'var(--bg)', overflowX: 'hidden' }}>
      ...
      <div style={{ maxWidth: 1080, margin: '0 auto', padding: '48px 24px 32px', position: 'relative' }}>
        ...
        <nav aria-label="Breadcrumb" style={{ fontSize: 12.5, color: 'var(--text-muted)', marginBottom: 22, display: 'flex', gap: 8, alignItems: 'center' }}>
          ...
          <span style={{ color: 'var(--text)' }}>{data.useCase}</span>
        </nav>
        ...
        <section style={{ marginBottom: 72 }}>
          <div style={{ marginBottom: 26 }}>
            ...
            <h2 className="display" style={{ fontSize: 'clamp(26px, 3.2vw, 36px)', fontWeight: 700, letterSpacing: '-0.025em', color: 'var(--text-strong)' }}>
              What people doing {data.useCaseShort} tell us they want to stop doing.
            </h2>
          </div>
        ...
        <section style={{ marginBottom: 72 }}>
          <div style={{ marginBottom: 26 }}>
            <div className="mono" style={{ fontSize: 11, color: 'var(--accent)', letterSpacing: 2.5, marginBottom: 12 }}>{data.useCase.toUpperCase()} WITH BANKXL</div>
            <h2 className="display" style={{ fontSize: 'clamp(26px, 3.2vw, 36px)', fontWeight: 700, letterSpacing: '-0.025em', color: 'var(--text-strong)' }}>
        ...
        <section style={{ marginBottom: 72 }}>
          <div style={{ marginBottom: 26 }}>
            ...
            <h2 className="display" style={{ fontSize: 'clamp(26px, 3.2vw, 36px)', fontWeight: 700, letterSpacing: '-0.025em', color: 'var(--text-strong)' }}>
              Everything {data.useCaseShort} needs.
            </h2>
          </div>
