  ...
  return (
    <LegalPage title="Refund & Cancellation Policy" updated="May 2026">
      ...
      <ul>
        ...
        <li>Email <a href="mailto:support@bankxl.in">support@bankxl.in</a> with the reason — we usually refund within 24 hours.</li>
      ...
      <p>Email <a href="mailto:privacy@bankxl.in">privacy@bankxl.in</a>. We will delete your account and all associated data within 7 days.</p>

      <h2>Refund timing</h2>
      <p>Once approved, refunds are issued by Stripe and typically arrive in 5–10 business days, depending on your card issuer.</p>

      <h2>Questions?</h2>
      <p>Reach us at <a href="mailto:support@bankxl.in">support@bankxl.in</a> — we read every email.</p>
    </LegalPage>
  )
}
