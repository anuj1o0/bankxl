  ...
  return (
    <LegalPage title="Refund & Cancellation Policy" updated="May 2026">
      ...
      <ul>
        ...
        <li>Email <a href="mailto:support@banlxlai.com">support@banlxlai.com</a> with the reason — we usually refund within 24 hours.</li>
      ...
      <h2>Questions?</h2>
      <p>Reach us at <a href="mailto:support@banlxlai.com">support@banlxlai.com</a> — we read every email.</p>
    </LegalPage>
  )
}
